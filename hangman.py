...
class Hangman:
    def __init__(self):
        self.quit = False
        self._window = None  # Initialize _window attribute
    ...
    def _draw_hanged_man(self):
        ...
        if self._wrong_guesses == 1:
            ...
            for i in range(self._wrong_guesses - 1):    # Draw all parts up to the current wrong guess
                for part in body[i]:
                    self._canvas.DrawLine(*part, color="red", width=10)
    ...
    def _initialize_game(self):
        ...
        self._guessed_letters = set()  # Initialize guessed_letters
    ...
    def _initialize_gui(self):
        ...
        self._canvas.DrawRectangle((0, 0), (200, 400), fill_color="white")  # Clear the canvas
        self._draw_scaffold()
    ...
    def check_winner(self):
        ...
        self.quit = not answer  # Reverse the logic, as PopupYesNo returns True for "Yes"
        if not self.quit:
            self._initialize_game()
